# PainelObrigacoes.Infrastructure.CrossCutting.IoC — Composição de Dependências
...
- PainelObrigacoes.Application
- PainelObrigacoes.Infrastructure.Data
- PainelObrigacoes.Infrastructure.Services
- Pacotes NuGet: MediatR, FluentValidation, AutoMapper, EF Core, Meilisearch, Redis

## Quem depende

- PainelObrigacoes.Api (chama `services.RegisterServices(configuration)` no Program.cs)
