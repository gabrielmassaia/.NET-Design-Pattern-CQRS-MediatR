# PainelObrigacoes.Infrastructure.Services — Serviços de Exportação
...
- PainelObrigacoes.Application (precisa dos ViewModels para gerar relatórios)
- Pacotes NuGet: QuestPDF

## Quem depende

- PainelObrigacoes.Infrastructure.CrossCutting.IoC (registra os serviços)
