# CleanArchReference.Application — Fachada da Aplicação
...
- CleanArchReference.Api (endpoints injetam AppServices)
- CleanArchReference.Infrastructure.Services (export usa ViewModels)
- CleanArchReference.Infrastructure.CrossCutting.IoC (registra AppServices)
