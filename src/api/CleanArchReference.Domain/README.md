# CleanArchReference.Domain — Núcleo do Negócio
...
- CleanArchReference.Application (usa Commands, Queries, Models)
- CleanArchReference.Infrastructure.Data (implementa interfaces de repositório)
- CleanArchReference.Infrastructure.CrossCutting.IoC (registra handlers)
