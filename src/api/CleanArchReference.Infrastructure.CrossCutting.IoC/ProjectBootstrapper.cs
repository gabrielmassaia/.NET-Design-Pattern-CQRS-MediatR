...
using CleanArchReference.Infrastructure.CrossCutting.IoC.Dashboard;
using CleanArchReference.Infrastructure.CrossCutting.IoC.Empresas;
using CleanArchReference.Infrastructure.CrossCutting.IoC.Obrigacoes;
using CleanArchReference.Infrastructure.CrossCutting.IoC.Tags;
using CleanArchReference.Infrastructure.Data.Context;
using CleanArchReference.Infrastructure.Data.Services;
...
public static class ProjectBootstrapper
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddHostedService<CleanArchReference.Infrastructure.Data.Search.MeilisearchIndexSetup>();
        ...
        var domainAssembly = typeof(CleanArchReference.Domain.Empresas.CommandHandlers
            .CreateEmpresaCommandHandler).Assembly;
        var infraAssembly = typeof(CleanArchReference.Infrastructure.Data.Events
        ...
        services.AddAutoMapper(
            typeof(CleanArchReference.Application.Empresas.AutoMapper.EmpresaProfile).Assembly);
