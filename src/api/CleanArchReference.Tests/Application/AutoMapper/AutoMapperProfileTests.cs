...
using CleanArchReference.Application.Dashboard.AutoMapper;
using CleanArchReference.Application.Empresas.AutoMapper;
using CleanArchReference.Application.Obrigacoes.AutoMapper;
...
namespace CleanArchReference.Tests.Application.AutoMapper;
